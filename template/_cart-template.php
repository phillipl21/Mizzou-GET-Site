        ...
        <div class="row">
            <div class="col-sm-9">
                ...
                <div class="row border-top py-3 mt-3">
                    <div class="col-sm-2">
                        <img src="<?php echo $item['item_image'] ?? "./assets/Foods/Burger & Fries.jpg" ?>" style="width:120px; height:120px;" alt="cart1" class="img-fluid">
                    </div>
                    <div class="col-sm-8">
                        <h5 class="font-poppins font-size-20 m-0"><?php echo $item['item_name'] ?? "Brand"; ?><small class="font-poppins font-size-12">(215 kcal per roll)</small></h5>
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        ...
                        <a href="confirmed.php" class="btn btn-warning mt-3">Proceed to Buy</a>
                    </div>
                </div>
            </div>
            <!-- !subtotal section -->
